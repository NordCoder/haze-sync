...
base_branch: main
base_sha: PR metadata reports base_sha 9ee3ced989bf60a71d0d7b37ff046118b0b2d1a2; compare_commits previously reported main at c1e69a664388b0cba028170e8398b9088218957d with merge base 9ee3ced989bf60a71d0d7b37ff046118b0b2d1a2
head_sha: 914751f361e159cab25c326c405445743a425972 before report-only commits; final head is the report update commit returned by GitHub contents API
...
ci_skip_used: yes
ci_skip_reason: final report updates modify only crates/haze-sync-common/control/report.md after source fixer commits were already committed without CI skip; skipped report-only workflows are not CI evidence
...
- observed Component CI run 29028045014 completed successfully for fixer source head 914751f361e159cab25c326c405445743a425972
...
deferred_work: CMM-P4 clean-code review after Orchestrator updates the control slot
...
- GitHub connector fetch_commit_workflow_runs for fixer source commit 914751f361e159cab25c326c405445743a425972; observed Component CI run 29028045014 completed with conclusion success
checks_not_run:
...
ci_status: CI_GREEN
workflow_urls: Component CI run 29028045014 completed successfully for fixer source commit 914751f361e159cab25c326c405445743a425972
known_failures: original diagnostics artifact reported rust-fmt failure only; no post-fix failure observed
...
- Report-only commits use `[skip ci]`; skipped report commits are not CI evidence and must not be treated as CI green. The CI evidence is Component CI run 29028045014 on source fixer commit 914751f361e159cab25c326c405445743a425972.
- component/common remains diverged from current main by normal commit graph; no merge/rebase/reset was performed.
...
FINAL_VERDICT:
FIX_COMPLETE — Applied the minimum rustfmt-equivalent formatting fix for the CMM-P4 CI failure inside common scope. Post-fix Component CI completed successfully for the source fixer head. Final report-only commits intentionally use CI skip and are not CI evidence.
