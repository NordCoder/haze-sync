...
pub use checks::{
    ...
    ObjectStoreExistsWritableInput, WorktreeDriftCheckInput, adapter_cursor_check,
    adapter_token_sanity_check, db_connectivity_check, gdrive_mapping_check,
...
pub use types::{
    ...
    DoctorCheckStatus, DoctorNotRunDetails, DoctorNotRunReason, DoctorPlaceholderDetails,
    DoctorPlaceholderReason, GdriveMappingDetails, MissingBlobDetectionDetails,
